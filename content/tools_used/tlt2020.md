...
- Managing _"Pull Requests" (PRs)_
   - Submit
   - Discuss
   - Merge
- Code Review
...
___
## Example tutorial as Jupyer notebook
...
- Branches:
   - _master_: where students will complete assignment
   - _original_: copy of starting files in _master_ branch
   - _Optional:_ _solution_: allows students to see your solutions
___
...
5. Commit _Markdown_ files into master branch
6. Push commits their repo on GitHub.
7. _Optionally:_ Check code passes tests
8. Submit a __pull request__ via GitHub to merge master branch into original branch
