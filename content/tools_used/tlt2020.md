...
___
<section>
  <iframe data-src="https://nbviewer.jupyter.org/github/PsuAstro528/TLTDemo-start/blob/main/ex1.ipynb" width="100%" height="700" style="vertical-align:top"></iframe>
</section>
___
...
7. Check code passes tests (hopefully)
...
- [NBViewer](https://nbviewer.jupyter.org/github/PsuAstro528/TLTDemo-start/blob/main/ex1.ipynb")
- [![Binder]( https://mybinder.org/badge_logo.svg)]( https://mybinder.org/v2/gh/PsuAstro528/TLTDemo-start/main?filepath=ex1.ipynb)
  <iframe data-src="" width="100%" height="700" style="vertical-align:top"></iframe>
