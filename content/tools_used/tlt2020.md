...
\*\* Using less-common presentation tools, e.g., [Reveal.js](https://revealjs.com/#/) and [Rise](https://rise.readthedocs.io/en/stable/index.html)

---
## [GitHub](https://github.com/)*
Cloud-based git servers and web interfaces that add valuable collaboration tools:
- Managing _"Pull Requests" (PRs)_: (Submit, Discuss, Merge)
- Code Review
- Bug/issue tracking
- Documentation
...
___
<section>
  <iframe data-src="https://nbviewer.jupyter.org/github/PsuAstro528/lab1-start/blob/master/ex2.ipynb" width="100%" height="700" style="vertical-align:top"></iframe>
</section>
___
...
- Interactive lessons
- Tutorials
- Assignments involving computation
...
___
TODO: Update figure
<img data-src="/images/tlt_github_diff_nb_1.png" width="100%">
___
TODO: Update figure
<img data-src="/images/tlt_github_diff_nb_2.png" width="100%">
...
___
### GitHub Classroom Workflow: 1. Create assignment
Instructor:  
...
- Test scripts
- _Optional_: config for CI testing (e.g., [Travis-CI.com](ttps://travis-ci.com/))
...
___
### GitHub Classroom Workflow:  2.  Do assignment
Student:  
1. Use link to create a private clone of the starter repo.
2. Clone the repository to their local computer (or ACI account)
3. Complete assignment(s) as Jupyter notebooks
4. Convert Jupyter notebooks into _Markdown_ format
5. Commit _Markdown_ files into main branch
6. Push commits their repo on GitHub.
7. _Optionally:_ Check code passes tests
8. Submit a __pull request__ via GitHub to merge main branch into original branch

___
### GitHub Classroom Workflow:  3. Discuss assignment
Student & Instructor:  
- Check if code passes automatic tests
- _Optionally:_ Update template repository with new tests
Instructor:  
...
- [NBViewer](https://nbviewer.jupyter.org/github/PsuAstro528/lab1-start/blob/master/ex2.ipynb)
- [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/PsuAstro528/lab1-start/master?filepath=ex2.ipynb)
